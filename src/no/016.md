...
- [PaperBanana: Automating Academic Illustration for AI Scientists](https://arxiv.org/abs/2601.23265)
  ...
  *Zhu et al. (Google Cloud AI Research + Peking University), arXiv, January 30 2026*

  Five-agent framework for publication-quality methodology diagrams, with a 72.7% win rate in blind human evaluation; an open-source reimplementation shipped this week extending it to slides, CLI, and MCP server integration, meaning figures are no longer the researcher's least-automatable deliverable.
