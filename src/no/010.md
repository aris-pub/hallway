...
Two papers this week frame the same problem from opposite ends. AutoScientists
argues that multi-agent research systems need governance mechanisms before they
need more capability. Tang and Yang show that the agents we already have cluster
tightly around existing work rather than opening new directions. Meanwhile,
Scientific Reports is still retracting papers where "surface tension" became
"floor anxiety" and no reviewer noticed. The capability question is increasingly
