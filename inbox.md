...
- https://www.sciencedirect.com/science/article/pii/S294988212500091X
  Computers in Human Behavior: Artificial Humans (Elsevier, open-access), 2025 — agent should WebFetch the article to identify title, authors, and findings (article not yet in search index). Journal focuses on humans interacting with AI agents/social robots/algorithmic systems — broadly on-beat if the piece is about research practice.
